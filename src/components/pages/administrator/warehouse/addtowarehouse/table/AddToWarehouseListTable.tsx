...
interface AddToWarehouseListTableProps {
	className?: string;
	items: TProduct[];
}

const AddToWarehouseListTable: FC<AddToWarehouseListTableProps> = ({ items = [], className = `` }) => {
	return (
...
export default AddToWarehouseListTable;
